...
def handleSqlToNLP(gQueryStatement, userInput):
    ...
    response = model.predict(
        ...
        {json_data} Generate a description for the following in the natural language but don't use the word json in 
        the statement. Pretend like you are interactive with the end user """,
        **parameters
    )
    print(response.text)
